"""Titanium's first-party Compose set.

These files are Titanium's own, consumed by every compose-driven environment —
...
from titanium.models.trial.config import ServiceVolumeConfig
