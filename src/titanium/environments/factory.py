...
_ENVIRONMENT_REGISTRY: dict[EnvironmentType, _EnvEntry] = {
    ...
    EnvironmentType.GVISOR: _EnvEntry(
        "titanium.environments.gvisor.environment",
        "GVisorEnvironment",
        None,
    ),
    EnvironmentType.GVISOR_PODMAN: _EnvEntry(
        "titanium.environments.gvisor.podman",
    ...
    EnvironmentType.MODAL: _EnvEntry(
        "titanium.environments.modal",
        "ModalEnvironment",
        "modal",
    ),
    EnvironmentType.DAYTONA: _EnvEntry(
        "titanium.environments.daytona",
        "DaytonaEnvironment",
        "daytona",
    ),
}
