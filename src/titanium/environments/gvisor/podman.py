...
* **Driving** comes from :class:`~titanium.environments.podman.podman.PodmanEnvironment`:
...
* **Sandboxing** comes from :class:`~titanium.environments.gvisor.environment.GVisorEnvironment`
...
:mod:`titanium.environments.gvisor.podman_runtime` for the specifics and how each
...
from titanium.environments.gvisor.runtime import DEFAULT_RUNTIME
...
class GVisorPodmanEnvironment(GVisorEnvironment, PodmanEnvironment):
    ...
    def __init__(self, *args, engine: str = "podman", **kwargs):
        ...
        # Host-side inspection and cleanup must honor TITANIUM_PODMAN_BIN exactly
