...
from titanium.metrics.factory import MetricFactory
from titanium.metrics.mean import Mean
from titanium.models.job.config import (
    DatasetConfig,
    JobConfig,
)
from titanium.models.job.lock import LOCK_FILENAME, JobLock, build_job_lock
from titanium.models.job.result import EvalsRewardsMap, JobResult, JobStats
from titanium.models.trial.config import TaskConfig, TrialConfig
from titanium.models.trial.paths import TrialPaths
from titanium.models.trial.result import TrialResult
from titanium.trial.hooks import HookCallback, TrialEvent, TrialHookEvent
from titanium.trial.queue import TrialQueue
from titanium.utils.logger import logger
from titanium.utils.pass_at_k import compute_pass_at_k_by_evals
...
class Job:
    ...
    def _write_job_lock(self) -> None:
        ...
        if self._job_lock_path.exists():
            ...
            self._job_lock.titanium = existing_job_lock.titanium
