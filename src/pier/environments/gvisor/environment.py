...
``GVisorEnvironment`` subclasses :class:`~pier.environments.docker.docker.DockerEnvironment`
...
``src/pier/environments/docker/`` is not modified at all.
...
class GVisorEnvironment(DockerEnvironment):
    ...
    def _reset_for_new_start_attempt(self) -> None:
        ...
        Pier -- not this class -- owns retry policy, and a retried start() can
